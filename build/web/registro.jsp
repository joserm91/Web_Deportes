<%-- 
    Document   : index
    Created on : 29-dic-2020, 19:52:59
    Author     : Ramos-PC
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="imagenes/LogoProductoNike.png" type="image/x-icon">
    </head>
    <%
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                            ...
                                                            <form id="register-form" action="ServletRegistro" method="POST" role="form" style="display: block;">
