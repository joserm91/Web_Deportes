...
<html lang="en">
    <head>
        ...
        <title>Zapatillas, Ropa y Accesorios Nike para Mujer. Nike ES</title>
    ...
    <%
        ...
        ArrayList<Producto> lista = DB.infoProductosPorCategoria(4);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-5 col-sm-10 producto">
                                ...
                                <img
                                    ...
                                    src="images_zapatillas/mujer/<%=info.getFoto()%>"
                                    alt=""
                                    srcset=""
                                    data-toggle="modal"
                                ...
                                <div class="descZapatilla">
                                    ...
                                    <a href="ServletCarrito?idproducto=<%=info.getId_producto()%>&pathInfo=mujer.jsp" class="btn btn-outline-dark btnAañadir"
