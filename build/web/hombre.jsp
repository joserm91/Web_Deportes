...
<html lang="en">
    <head>
        ...
        <title>Zapatillas, Ropa y Accesorios Nike para Hombre. Nike ES</title>
    ...
    <%
        ...
        ArrayList<Producto> lista = DB.infoProductosPorCategoria(3);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-5 col-sm-10 producto">
                                ...
                                <img
                                    ...
                                    src="images_zapatillas/hombre/<%=info.getFoto()%>"
                                    alt=""
                                    srcset=""
                                    data-toggle="modal"
